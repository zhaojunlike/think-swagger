...
<script type="text/javascript" src="{$assets_path}swagger-ui-bundle.js"></script>
<script type="text/javascript" src="{$assets_path}swagger-ui-standalone-preset.js"></script>

<script>
    window.onload = function() {
        // Build a system
        const ui = SwaggerUIBundle({$configurations});

        window.ui = ui;
        {if condition="$oauthConfiguration neq ''"}
